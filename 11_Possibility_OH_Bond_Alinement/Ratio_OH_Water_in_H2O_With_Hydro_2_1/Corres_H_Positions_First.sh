...
########################################################
#Python count number of H-bonded to the same O in water#
#(inclduing protons) for each step######################
########################################################
...
if int(proton_num_whole)!=0:
    data_protn_binded_O_list = np.genfromtxt('Final_proton_bonded_O_reorder_list_Final', delimiter='')
...
#########################################
#Python create H positions for each step#
#########################################
...
rm H_list_step_second WOH_position Final_O_uporder_list_Final
